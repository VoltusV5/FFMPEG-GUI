...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1716, 958)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.horizontalLayoutWidget_7 = QWidget(self.centralwidget)
        self.horizontalLayoutWidget_7.setObjectName(u"horizontalLayoutWidget_7")
        self.horizontalLayoutWidget_7.setGeometry(QRect(20, 590, 331, 41))
        ...
        self.QueueUp.setMaximumSize(QSize(40, 16777215))
        ...
        self.presetEditorContainer.setGeometry(QRect(820, 10, 591, 291))
        self.verticalLayoutWidget_3 = QWidget(self.presetEditorContainer)
        self.verticalLayoutWidget_3.setObjectName(u"verticalLayoutWidget_3")
        self.verticalLayoutWidget_3.setGeometry(QRect(0, 0, 591, 291))
        ...
        self.savePresetWithCustomParamsButton.setMaximumSize(QSize(16777215, 16777215))

        self.presetEditorBottomButtonsLayout.addWidget(self.savePresetWithCustomParamsButton)

        self.PresetUp = QPushButton(self.verticalLayoutWidget_3)
        self.PresetUp.setObjectName(u"PresetUp")
        self.PresetUp.setMaximumSize(QSize(40, 16777215))

        self.presetEditorBottomButtonsLayout.addWidget(self.PresetUp)

        self.PresetDown = QPushButton(self.verticalLayoutWidget_3)
        self.PresetDown.setObjectName(u"PresetDown")
        self.PresetDown.setMaximumSize(QSize(40, 16777215))

        self.presetEditorBottomButtonsLayout.addWidget(self.PresetDown)

        self.presetEditorBottomButtonsLayout.setStretch(0, 4)
        self.presetEditorBottomButtonsLayout.setStretch(1, 3)
        self.presetEditorBottomButtonsLayout.setStretch(2, 1)
        self.presetEditorBottomButtonsLayout.setStretch(3, 1)
        self.presetEditorBottomButtonsLayout.setStretch(4, 1)
        ...
        self.presetSettingsContainer.setGeometry(QRect(820, 320, 591, 391))
        self.verticalLayoutWidget_4 = QWidget(self.presetSettingsContainer)
        self.verticalLayoutWidget_4.setObjectName(u"verticalLayoutWidget_4")
        self.verticalLayoutWidget_4.setGeometry(QRect(0, 0, 591, 341))
        ...
        self.widget_2.setGeometry(QRect(20, 650, 791, 251))
        self.logDisplay = QTextEdit(self.widget_2)
        self.logDisplay.setObjectName(u"logDisplay")
        self.logDisplay.setGeometry(QRect(0, 30, 771, 211))
        ...
        self.totalQueueProgressBar.setGeometry(QRect(360, 600, 431, 21))
        ...
        self.widget.setGeometry(QRect(820, 710, 591, 191))
        self.horizontalLayoutWidget_6 = QWidget(self.widget)
        self.horizontalLayoutWidget_6.setObjectName(u"horizontalLayoutWidget_6")
        self.horizontalLayoutWidget_6.setGeometry(QRect(0, 22, 491, 151))
        ...
        self.copyCmdButton.setGeometry(QRect(500, 20, 91, 21))
        self.label_6 = QLabel(self.widget)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(0, 0, 131, 20))
        self.saveCurrentCommand = QPushButton(self.widget)
        self.saveCurrentCommand.setObjectName(u"saveCurrentCommand")
        self.saveCurrentCommand.setGeometry(QRect(500, 100, 91, 21))
        self.deleteSavedCommand = QPushButton(self.widget)
        self.deleteSavedCommand.setObjectName(u"deleteSavedCommand")
        self.deleteSavedCommand.setGeometry(QRect(500, 140, 91, 21))
        self.loadSavedCommand = QPushButton(self.widget)
        self.loadSavedCommand.setObjectName(u"loadSavedCommand")
        self.loadSavedCommand.setGeometry(QRect(500, 60, 91, 21))
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1716, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.presetExportButton.setText(QCoreApplication.translate("MainWindow", u"\u042d\u043a\u0441\u043f\u043e\u0440\u0442 \u043d\u0430\u0441\u0442\u0440\u043e\u0435\u043a", None))
        self.presetImportButton.setText(QCoreApplication.translate("MainWindow", u"\u0418\u043c\u043f\u043e\u0440\u0442 \u043d\u0430\u0441\u0442\u0440\u043e\u0435\u043a", None))
        ...
        self.savePresetWithCustomParamsButton.setText(QCoreApplication.translate("MainWindow", u"\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u043f\u0440\u0435\u0441\u0435\u0442 (+extra)", None))
        self.PresetUp.setText(QCoreApplication.translate("MainWindow", u"\u2191", None))
        self.PresetDown.setText(QCoreApplication.translate("MainWindow", u"\u2193", None))
        ...
        self.saveCurrentCommand.setText(QCoreApplication.translate("MainWindow", u"\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c", None))
        self.deleteSavedCommand.setText(QCoreApplication.translate("MainWindow", u"\u0423\u0434\u0430\u043b\u0438\u0442\u044c", None))
        self.loadSavedCommand.setText(QCoreApplication.translate("MainWindow", u"\u0412\u044b\u0431\u0440\u0430\u0442\u044c", None))
